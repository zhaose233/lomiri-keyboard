...
QuickAdapter::QuickAdapter(QObject *parent) :
    QObject(parent),
...
void QuickAdapter::parse(const QString& string)
{
...
void QuickAdapter::clearQuickPreedit()
{
    // Not Using
}

void QuickAdapter::wordCandidateSelected(const QString& word)
{
    Q_UNUSED(word)
}

void QuickAdapter::reset()
{
    clearQuickPreedit();
}
